...
static constexpr size_t WAV_DATA_SIZE = 46000;
...
void loop(void)
{
  ...
  for (int i = 0; i < remain; i += 2) {
    ...
    // 8bit の 0x80 が中心なので、0x80 を引いて符号付きにし、256倍する
    int16_t sample = (int16_t)(wav_8bit_44100[wav_pos] - 128) << 8;
